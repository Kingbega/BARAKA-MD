    ...
    try {
        ...
        const Matrix = makeWASocket({
            ...
            getMessage: async (key) => {
                ...
                return { conversation: "BEST WHATSAPP BOT MADE BY BARAKA BEGA" };
            }
        });
...
app.get('/', (req, res) => {
    res.send('BARAKA MD CONNECTED SUCCESSFULLY 😊');
});
